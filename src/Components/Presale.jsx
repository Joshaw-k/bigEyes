  ...
  return (
    <div className="bg-[#FFDCAA] py-12 px-3">
      <div className="bg-[#A6E8FE] w-[90%] max-w-[900px] overflow-hidden m-auto border-2 border-[#5B5B5B] rounded-[3.5rem] shadow-black shadow">
        ...
        <div className="bg-white flex flex-col items-start gap-x-10 lg:flex-row lg:px-8 divide-x-2 divide-black border-t-2 border-black">
          <div className="border-2 py-10 my-16 px-8 border-[#C4C4C4] rounded-3xl w-[90%] max-w-lg mx-auto">
            <div className="flex flex-col gap-y-8">
              <h3 className="text-center font-semibold text-[#F38590]">
                PRESALE ENDED
              </h3>
              <button className="bg-[#F38590] w-full py-2 text-white rounded-full border-4 border-[#F9C7CC] transition hover:text-black hover:bg-[#F9C7CC] duration-300 ease-in">
                Connect Wallet
              </button>
            </div>
          </div>
          <div className="w-[90%] lg:w-full my-16 max-w-lg m-auto">
            ...
            <div className="mt-14 px-4">
              <div className="flex flex-col gap-y-6">
                <h3 className="text-center font-semibold text-[#999999]">
                  PRESALE ENDED
                </h3>
